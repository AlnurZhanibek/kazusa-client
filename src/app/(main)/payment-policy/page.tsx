...
export default function Page() {
  return (
    <div className={styles.wrapper}>
      ...
      <section>
        <h2 className={styles.heading}>Гарантии безопасности</h2>
        <p className={styles.paragraph}>
      ...
      <section>
        <h2 className={styles.heading}>Безопасность онлайн-платежей</h2>
        <p className={styles.paragraph}>
      ...
      <section>
        <h2 className={styles.heading}>Возврат денежных средств</h2>
        <p className={styles.paragraph}>
      ...
      <section>
        <h2 className={styles.heading}>Случаи отказа в совершении платежа:</h2>
        <ul>
          <li>
      ...
      <section>
        <h2 className={styles.heading}>Конфиденциальность</h2>
        <ol>
          <li>Определения</li>
          <p className={styles.paragraph}>
      ...
      <section>
        <h2 className={styles.heading}>Юридическое лицо</h2>
